...
public class bookroom extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) throws NullPointerException{
        ...
        list_itemArrayList.add(new list_item("JAVASCRIPT",1 ,"123"));
        list_itemArrayList.add(new list_item("ASDF",1,"2,200"));
        list_itemArrayList.add(new list_item("PyTHon",1,"ii,iii"));
        ...
        myListAdapter = new MyListAdapter(bookroom.this,list_itemArrayList);
        ...
        if(intent.getExtras() != null){
            list_itemArrayList.add(new list_item(intent.getStringExtra("name").toString(),intent.getIntExtra("amount",0),intent.getStringExtra("price").toString()));
        }
